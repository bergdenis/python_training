...
def test_phones_on_home_page(app):
    ...
    assert contact_from_home_page.secondary_number == clear(contact_from_edit_page.secondary_number)
...
def test_phones_on_contact_view_page(app):
    ...
    assert contact_from_view_page.secondary_number == contact_from_edit_page.secondary_number
